  ...
  new Promise(async (resolve, reject) => {
    ...
    const emailInfo = {
      ...
      html: `<div style="max-width: 600px; margin: 0 auto; padding: 20px;">
                ...
                <p><a href="http://localhost:3001/api/auth/verify/${confirmCode}" style="display: inline-block; padding: 10px 20px; background-color: #007bff; color: #ffffff; text-decoration: none;">http://localhost:3001/api/user/verify/${confirmCode}</a></p>
